...
trait MockDeletePensionsConnector extends TestSuite with MockFactory {
  ...
  object MockDeletePensionsIncomeConnector {
    ...
    def delete(requestData: DeletePensionsRequestData): CallHandler[Future[DownstreamOutcome[Unit]]] = {
      (mockDeletePensionsIncomeConnector
        .deletePensionsIncome(_: DeletePensionsRequestData)(_: HeaderCarrier, _: ExecutionContext, _: String))
        .expects(requestData, *, *, *)
    }
