...
import shared.models.errors.{BadRequestError, ErrorWrapper, NinoFormatError, RuleTaxYearNotSupportedError, RuleTaxYearRangeInvalidError, TaxYearFormatError}
  ...
  "running a validation" should {
    "return no errors" when {
      "a valid request is supplied" in {
        ...
        result shouldBe Right(RetrievePensionsRequestData(parsedNino, parsedTaxYear))
      }
    }
