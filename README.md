...
This API allows a developer to create, amend, retrieve and delete data relating to Pensions Income.
...
```bash
sm2 -start MTDFB_INDIVIDUALS_PENSIONS_INCOME_API
```
...
Available on the [HMRC Developer Hub](https://developer.service.hmrc.gov.uk/api-documentation/docs/api/service/individuals-pensions-income-api)
